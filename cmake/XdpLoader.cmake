...
add_executable(l4lb-xdp src/xdp/main.cpp src/xdp/loader.cpp src/xdp/MapStore.cpp src/control/XdpConfigSync.cpp src/xdp/DsrMapStore.cpp src/control/DsrConfigSync.cpp)
...
if(BUILD_TESTING)
  add_executable(udp_dsr_config_test tests/UdpDsrConfig_test.cpp src/xdp/loader.cpp src/xdp/DsrMapStore.cpp src/control/DsrConfigSync.cpp src/xdp/MapStore.cpp src/control/XdpConfigSync.cpp)
  target_include_directories(udp_dsr_config_test PRIVATE "${L4LB_LIBBPF_INCLUDE_DIR}" "${PROJECT_SOURCE_DIR}/src")
  target_link_libraries(udp_dsr_config_test PRIVATE "${L4LB_LIBBPF_LIBRARY}")
  add_dependencies(udp_dsr_config_test l4lb_xdp)
  add_test(NAME udp_dsr_config COMMAND udp_dsr_config_test "${CMAKE_CURRENT_BINARY_DIR}/xdp/xdp_udp_dsr.bpf.o")
  set_tests_properties(udp_dsr_config PROPERTIES LABELS "xdp_dsr" TIMEOUT 20)
endif()

if(BUILD_TESTING)
  add_test(NAME udp_dsr_cli COMMAND "${Python3_EXECUTABLE}" "${PROJECT_SOURCE_DIR}/tests/udp_dsr_cli_test.py"
    --loader "$<TARGET_FILE:l4lb-xdp>" --validator "$<TARGET_FILE:udp_dsr_config_test>" --clang "${L4LB_BPF_CLANG}" --source "${PROJECT_SOURCE_DIR}/src/xdp/xdp_udp_dsr.bpf.c")
  set_tests_properties(udp_dsr_cli PROPERTIES LABELS "xdp_dsr" TIMEOUT 30)
endif()
